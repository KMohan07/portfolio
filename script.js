document.addEventListener('DOMContentLoaded', () => {
    ...
    const hoverElements = document.querySelectorAll('a, button, .project-card, .glitch-hover, .code-tab');
    ...
    // 4. Project Code snippet Switcher
    ...
    codeTabs.forEach(tab => {
        tab.addEventListener('click', () => {
            ...
            // Find target snippet and show it
            const targetId = `code-${tab.getAttribute('data-code')}`;
    ...
    // 6. Quantum Background Particle Animation (Updated for repulsor effect)
